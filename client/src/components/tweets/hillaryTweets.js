...
import { fetchHillaryTweets, latestHillaryTweets } from '../../store/actions/tweetsActions';

class HillaryTweets extends Component {
  constructor(props) {
    super(props);
    this.state = { items: [], searchTerm: "Hillary Clinton" };
  ...
  render() {
    console.log(this.props.tweets.hillaryLatest);
...
export default connect(mapStateToProps, { fetchHillaryTweets, latestHillaryTweets })(HillaryTweets);